...
export const ROLE_ROUTES: Record<Role, string[]> = {
  ...
  Receiver: ["/", "/inbound", "/inventory", "/pallets", "/counting", "/crossdock", "/catch-weight", "/health", "/rf/receiving", "/rf/putaway"],
  Picker: ["/", "/orders", "/allocation", "/shipments", "/inventory", "/counting", "/crossdock", "/catch-weight", "/health", "/rf/pick", "/rf/move", "/rf/inquiry"],
