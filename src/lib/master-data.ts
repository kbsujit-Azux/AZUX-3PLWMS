...
export async function addItemToMaster(rec: Omit<ItemMasterRecord, "cbmPerCase" | "source" | "effectiveAt" | "active" | "hazmat"> & Partial<Pick<ItemMasterRecord, "source" | "active" | "hazmat">>): Promise<ItemMasterRecord> {
