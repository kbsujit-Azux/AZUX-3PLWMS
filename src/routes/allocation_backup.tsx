        ...
        <DialogContent className="sm:max-w-lg">
          ...
          {palletizeOpen.orderId &&
            (() => {
              ...
              const orderTickets = pickTickets.filter((pt) => pt.orderId === order.id);
              const totalUnits = orderTickets.reduce(
                (s, pt) => s + (pt.qtyPicked || pt.quantityToPick),
                0,
              );
              const recommendedPallets = Math.max(1, Math.ceil(totalUnits / 480));
              return (
                      ...
                      {orderTickets.map((pt) => (
                        ...
                        >
                          ...
                          <span className="tabular-nums">
                            {pt.qtyPicked || pt.quantityToPick} units
                          </span>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-end">
                      <div className="text-[10px] text-muted-foreground">
                        Recommended: {recommendedPallets} pallets (480 units/pallet max)
                        <br />
